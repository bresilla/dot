...
-- The name is fixed at generation time; the version comes from meson.build, the language's own
...
local VERSION = ((oslo.fs.read("meson.build") or ""):match("version:%s*'([^']+)'")) or "0.0.0"
