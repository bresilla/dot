...
-- The name is fixed at generation time; the version comes from xmake.lua, the language's own
...
local VERSION = ((oslo.fs.read("xmake.lua") or ""):match('set_version%("([^"]+)"')) or "0.0.0"
