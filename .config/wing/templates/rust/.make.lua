...
-- The name is fixed at generation time; the version comes from Cargo.toml, the language's own
...
local VERSION = ((oslo.fs.read("Cargo.toml") or ""):match('version%s*=%s*"([^"]+)"')) or "0.0.0"
